...
def setup_training_loop_kwargs(
    ...
    cfg_specs = {
        ...
        'fusionstyles_8gpus': dict(ref_gpus=8,  kimg=25000,  mb=32, mbstd=4,  fmaps=1,   lrate=0.001,  gamma=10,   ema=10,  ramp=None, map=8), # Uses mixed-precision, unlike the original StyleGAN2.
        'fusionstyles': dict(ref_gpus=4,  kimg=25000,  mb=32, mbstd=8,  fmaps=1,   lrate=0.001,  gamma=10,   ema=10,  ramp=None, map=8),
...
# Base config.
@click.option('--cfg', help='Base config [default: auto]', type=click.Choice(['auto', 'stylegan2', 'paper256', 'paper512', 'paper1024', 'cifar', 'fusionstyles', 'fusionstyles_8gpus']))
